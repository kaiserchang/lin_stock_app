...
# 6. 說明折疊面板與結果呈現
# ==========================================
with st.expander("📖 林家洋技術分析型態與實戰戰術指南 (2026 實戰升級版)", expanded=True):
    st.markdown("""
    ### 🎯 五大型態判讀與實戰戰術指引
    * 🚀 **順勢強攻 (突破高點)**：季線之上的攻擊K線，突破近 20 日波段高點。
      * **戰術定位**：主力表態發動訊號。
      * **實戰進場檢核**：
        * ✅ **黃金買點**：近 20 日累積漲幅 $\le 15\%$、季線乖離 $\le 12\%$ 之「底部/平台突破第一根」，勝率最高。
        * ⚠️ **力竭警戒**：若 20 日漲幅已 $> 25\%$ 或季線乖離 $> 18\%$，屬高檔力竭出貨風險區，**嚴禁追高**。
      * **防守停損點**：以**發動日攻擊K最低點（Low）**為唯一基準線（破線果斷停損）。
    * 🔥 **多頭反轉 (吞噬賣壓)**：季線之上的多頭吞噬，紅K實體完全包覆前日黑K。
      * **戰術定位**：回檔轉折止跌訊號。次日若能補量續強，可視為波段加碼契機。
    ...
    * 💣 **黑K吞噬 (逃命警示)**：長黑K實體完全包覆前日紅K。
    ...
    ---
    ### 🔥 實戰下單 3 大鐵律
    1. 🌊 **族群共振優先**：同產業有 2 檔以上同時跳出 🚀 時，為當日勝率最高之「明日實戰 TOP 3」。
    2. ⏰ **避開開盤追高**：次日 9:00~9:30 觀察隔日沖賣壓消化情況，建議於 9:30 後或回測發動K棒 1/2 處逢低掛單。
    3. 🛑 **破攻擊K低點必砍**：進場後若收盤跌破發動日最低價（約 -3.5%~-4%），無條件停損結案，絕不向下攤平。
    """)
